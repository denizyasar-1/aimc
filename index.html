...
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width,初始.scale=1" />
  <title>Renkli Mini Minecraft - Çok Oyunculu</title>
  <style>
    ...
    function connectToServer() {
      try {
        ...
        import('socket.io').then(({ default: io }) => {
          socket = io('https://aimc.onrender.com'); // Gerçek sunucu adresinizi buraya yazın
